class Config(object):
    ...
    def __init__(self):
        ...
        # data related
        self.dataset = 'yfcc'
        self.data_te = '/home/OANet/modify_ddp/data_dump/yfcc-sift-2000-test.hdf5' # yfcc-sift-2000-test.hdf5 or sun3d-sift-2000-test.hdf5
        self.data_tr = '/home/OANet/modify_ddp/data_dump/yfcc-sift-2000-train.hdf5' # yfcc-sift-2000-train.hdf5 or sun3d-sift-2000-train.hdf5
        self.data_va = '/home/OANet/modify_ddp/data_dump/yfcc-sift-2000-val.hdf5' # yfcc-sift-2000-val.hdf5 or or sun3d-sift-2000-val.hdf5
        ...
        self.pretrained = '' # yfcc essential and fundamental, sun3d, gl3d
        ...
        # testing related
        self.use_ransac = True # use ransac when testing?
