...
def computeNN(desc_ii, desc_jj):
    """
    :param desc_ii: describer of image A
    :param desc_jj: describer of image B
    :return: index of matching keypoint, matching probability, Mutual Nearest Neighbor Judgment
    """
